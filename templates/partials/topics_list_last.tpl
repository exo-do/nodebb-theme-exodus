<ul component="category" class="topic-list" itemscope itemtype="http://www.schema.org/ItemList" data-nextstart="{nextStart}">
	...
	<!-- BEGIN topics -->
	<li component="category/topic" class="clearfix {function.generateTopicClass}" <!-- IMPORT partials/data/category.tpl -->>
		...
		<div class="col-lg-7 col-md-7 col-sm-9 col-xs-10 content">
			<div class="avatar pull-left">
				...
				<small>
					<a href="{config.relative_path}/category/{topics.category.slug}"><span class="fa-stack fa-lg"><i style="color:{topics.category.bgColor};"class="fa fa-circle fa-stack-2x"></i><i style="color:{topics.category.color};" class="fa {topics.category.icon} fa-stack-1x"></i></span></a> &bull;
				</small>
